...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /**
     * Backend:
     * Configuracion global de CORS para toda la aplicacion (Permisos para acceder o restringir ciertos dominios)
     */
    @Bean
    CorsConfigurationSource corsConfigurationSource()
    {
        ...
        configuration.setAllowedOriginPatterns(List.of("https://spring-security-jwt-production.up.railway.app/", "https://angular-springboot1-beta.vercel.app"));
